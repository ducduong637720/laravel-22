        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-warning">
                    <form class="form-horizontal" method="POST" action="{{ route('backend.products.update', $product->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="quatity" value="{{ $product->quatity }}"
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="{{ $product->status }}">{!! $product->status_text !!}</option>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="orgin_price" value="{{ $product->orgin_price }}" class="form-control" placeholder="Nhập ...">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <!-- text input -->
                                    <div class="form-group">
                                        <label>Giá bán</label>
                                        <input type="text" name="sale_price" value="{{ $product->sale_price }}" class="form-control" placeholder="Nhập ...">
                                    </div>
                                </div>
                            </div>
                            <div class="row"></div>
