...
@section('page-content')
        ...
        <div id="rev_slider_1050_1" class="slider-dots rev_slider fullscreenbanner" style="display:none;"
            ...
            <ul>
                ...
                <li data-index="rs-2938" data-transition="slideleft" data-slotamount="default" data-hideafterloop="0"
                    ...
                    data-thumb="/frontend/images/main-slider/slider2/1.jpg" data-rotate="0" data-fsslotamount="7"
                    data-saveperformance="off" data-title="" data-param1="Additional Text" data-param2="" data-param3=""
                    data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                    data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="/frontend/images/main-slider/slider2/1.jpg" alt="" data-bgposition="center center"
                    ...
                    <div class="tp-caption WebProduct-Title   tp-resizeme" id="slide-2938-layer-01"
                        ...
                        <div class="text-secondry"> Nơi tốt nhất <span class="text-primary"> cho bạn</span></div>
                    </div>
                ...
                <li data-index="rs-2939" data-transition="slideleft" data-slotamount="default" data-hideafterloop="0"
                    data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default"
                    data-thumb="/frontend/images/main-slider/slider2/2.jpg" data-rotate="0" data-saveperformance="off"
                    data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                    data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="/frontend/images/main-slider/slider2/2.jpg" alt="" data-bgposition="center center"
                        data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                ...
                <li data-index="rs-2940" data-transition="slideleft" data-slotamount="default" data-hideafterloop="0"
                    data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default"
                    data-thumb="/frontend/images/main-slider/slider2/3.jpg" data-rotate="0" data-fsslotamount="7"
                    data-saveperformance="off" data-title="" data-param1="Additional Text" data-param2="" data-param3=""
                    data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                    data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="/frontend/images/main-slider/slider2/3.jpg" alt="" data-bgposition="center center"
                        data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
        ...
        <div class="container ">
            ...
            <div class="section-content text-center about-spa">
                <p>
                    ...
                    into electronic typesetting, remaining unchanged. It was popularised in the 1960s with the release Ipsum
                    ...
                    <div class="col-md-4 col-sm-4 m-b30">
                        <div class="wt-icon-box-wraper p-a30 center">
                            <div class="icon-xl radius m-b20 circle-line-effect">
                                <span class="icon-cell text-white"><img src="/frontend/images/circle-block/lieuphap.jpg"
                                        alt="" class="radius-bx overflow-hide img-full"></span>
                            </div>
                ...
                <div>
                    ...
                    <a class="m-b15 site-button-secondry text-uppercase radius-sm m-lr15 font-weight-700 button-lg">More
                        Detail</a>
                </div>
            </div>
        </div>
                        ...
                        <div data-toggle="tab" data-target="#pricing-item3" class="tab-block">
                            <div class="our-pricing-tab  radius-sm bdr-1 bdr-gray">
                                <div class="wt-icon-box-wraper center  p-lr10">
                                    ...
                                    <div class="icon-content">
                                        <span
                                            class="wt-tilte text-uppercase p-b10 inline-block font-weight-600">Waxing</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div data-toggle="tab" data-target="#pricing-item4" class="tab-block">
                            <div class="our-pricing-tab  radius-sm bdr-1 bdr-gray">
                                <div class="wt-icon-box-wraper center  p-lr10">
                                    ...
                                    <div class="icon-content">
                                        <span
                                            class="wt-tilte text-uppercase p-b10 inline-block font-weight-600">Facial</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div data-toggle="tab" data-target="#pricing-item5" class="tab-block">
                            <div class="our-pricing-tab  radius-sm bdr-1 bdr-gray">
                                <div class="wt-icon-box-wraper center  p-lr10">
                                    ...
                                    <div class="icon-content">
                                        <span
                                            class="wt-tilte text-uppercase p-b10 inline-block font-weight-600">Massage</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section-content p-t50">
                        ...
                        <div class="wt-tabs vertical bg-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#pricing-tab1-1">Massage Therapy</a>
                                </li>
    ...
    <div class="section-full overlay-wraper bg-center bg-cover p-tb80 bg-primary"
        style="background-image:url(/frontend/images/background/bg-9.jpg);">
    ...
    <div class="section-full bg-primary">
        <div class="container-fluid bg-top-right bg-no-repeat bg-full-height special-offer-block no-col-gap"
            style="background-image:url(/frontend/images/quangcao.png);">
            <div class="row">
                            ...
                            <div class="wt-box">
                                ...
                                <div class="wt-info bg-white text-center bdr-5 bdr-primary">
                                    ...
                                    <div class="wt-info-text p-a30">
                                        <h3>Back Massage</h3>
                                        <p>Lorem Khaled Ipsum is a major key to success. Put it this way, it took me twenty
                                            five years to get these plants.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pricingtable-wrapper pricing-table-style-4">
                                <div class="pricingtable-inner bg-white radius">
                                    ...
                                    <div class="overlay-wraper pricingtable-inner-overlay bg-no-repeat bg-cover"
                                        style="background-image:url(/frontend/images/our-work/pic1.jpg);">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 m-b40">
                            <div class="pricingtable-wrapper pricing-table-style-4">
                                <div class="pricingtable-inner bg-white radius">
                                    ...
                                    <div class="overlay-wraper pricingtable-inner-overlay bg-no-repeat bg-cover"
                                        style="background-image:url(/frontend/images/our-work/pic2.jpg);">
                                        <div class="pricingtable-title">
                                            <h3>Pro Plan</h3>
                                        </div>
                                        <div class="pricingtable-price">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 m-b40">
                            <div class="pricingtable-wrapper pricing-table-style-4">
                                <div class="pricingtable-inner bg-white radius">
                                    ...
                                    <div class="overlay-wraper pricingtable-inner-overlay bg-no-repeat bg-cover"
                                        style="background-image:url(/frontend/images/our-work/pic3.jpg);">
                                        <div class="pricingtable-title">
                                            <h3>Premium Plan</h3>
                                        </div>
                                        <div class="pricingtable-price">
        ...
        <div class="container equal-wraper no-col-gap">
            ...
            <div class="row conntact-home bg-gray">
                <div class="col-md-4 col-sm-6 contact-home-left bg-no-repeat bg-primary bg-left-center"
                    style="background-image:url(/frontend/images/background/contact-map.png);">
                    <div class="section-content">
                        <div class="p-a50">
