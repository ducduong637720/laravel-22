            ...
            <div class="section-content">
                ...
                <div class="col-md-6 m-b30">
                    ...
                    <div class="wt-box your-order-list">
                        <ul>
                            <li>L’Oreal Hair Spa Nourishing Creambath <strong
                                    class="pull-right text-primary">$15.00</strong></li>
                            <li>Spa Fit Smoothing & Refining Scrub By The Body Shop <strong
                                    class="pull-right text-primary">$150.00</strong></li>
                            <li>Avon Planet Spa Himalayan Goji Berry Conditioning <strong
                                    class="pull-right text-primary">$15.00</strong></li>
                            <li>Swedish Spa Beauty Wonder Oil By Oriflame <strong
                                    class="pull-right text-primary">$20.00</strong></li>
                            <li>Bio Argan Oil By Lakme <strong class="pull-right text-primary">$30.00</strong></li>
                            ...
                            <li><b> Cart Total</b><strong class="pull-right text-primary">$280.00</strong></li>
                        </ul>
                    </div>
                </div>
