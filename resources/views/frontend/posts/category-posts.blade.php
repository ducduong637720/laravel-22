            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="portfolio-wrap wt-blog-grid-2" style="position: relative; height: 1776.83px;">
                        ...
                        <!-- COLUMNS 1 --> 
                        <div class="post masonry-item col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position: absolute; left: 0px; top: 0px;">
                            <div class="blog-post blog-grid date-style-1">
                                ...
                                <div class="wt-post-info p-tb30 p-m30 bg-white">
                                    <div class="wt-post-title ">
                                        <h3 class="post-title"><a href="javascript:void(0);">Blogpost With Youtube Video</a></h3>
                                    </div>
                        ...
                        <!-- COLUMNS 2 --> 
                        <div class="post masonry-item col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position: absolute; left: 438px; top: 0px;">
                            <div class="blog-post blog-grid date-style-1">
                                <div class="wt-post-media wt-img-effect zoom-slow">
                        ...
                        <!-- COLUMNS 3 --> 
                        <div class="post masonry-item col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position: absolute; left: 0px; top: 550px;">
                            <div class="blog-post blog-grid date-style-1">
                                <div class="wt-post-media">
                                    ...
                                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-878px, 0px, 0px); transition: all 0s ease 0s; width: 3073px;"><div class="owl-item cloned" style="width: 409px; margin-right: 30px;"><div class="item">
                                            <div class="aon-thum-bx">
                                                <img src="/frontend/images/blog/grid/pic2.jpg" alt="">
                                            </div>
                                        </div></div><div class="owl-item cloned" style="width: 409px; margin-right: 30px;"><div class="item">
                                            <div class="aon-thum-bx">
                                                <img src="/frontend/images/blog/grid/pic3.jpg" alt="">
                                            </div>
                                        </div></div><div class="owl-item active" style="width: 409px; margin-right: 30px;"><div class="item">
                                            <div class="aon-thum-bx">
                                                <img src="/frontend/images/blog/grid/pic1.jpg" alt="">
                                            </div>
                                        </div></div><div class="owl-item" style="width: 409px; margin-right: 30px;"><div class="item">
                                            <div class="aon-thum-bx">
                                                <img src="/frontend/images/blog/grid/pic2.jpg" alt="">
                                            </div>
                                        </div></div><div class="owl-item" style="width: 409px; margin-right: 30px;"><div class="item">
                        ...
                        <!-- COLUMNS 4 --> 
                        <div class="post masonry-item col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position: absolute; left: 438px; top: 550px;">
                            <div class="blog-post blog-grid date-style-1">
                                <div class="wt-post-media wt-img-effect zoom-slow">
                        ...
                        <!-- COLUMNS 5 --> 
                        <div class="post masonry-item col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position: absolute; left: 438px; top: 1163px;">
                            <div class="blog-post blog-grid date-style-1">
                                <div class="wt-post-media wt-img-effect zoom-slow">
                        ...
                        <!-- COLUMNS 6 --> 
                        <div class="post masonry-item col-lg-6 col-md-6 col-sm-6 col-xs-12" style="position: absolute; left: 0px; top: 1163px;">
                            <div class="blog-post blog-grid date-style-1">
                                <div class="wt-post-media wt-img-effect zoom-slow">
                ...
                <div class="col-md-3">
                    ...
                    <aside class="side-bar">
                        ...
                        <div class="widget">
                            ...
                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-526px, 0px, 0px); transition: all 0.25s ease 0s; width: 1841px;"><div class="owl-item cloned" style="width: 263px;"><div class="item">
